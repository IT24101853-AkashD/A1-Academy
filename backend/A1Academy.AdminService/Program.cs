        ...
        options.Events = new JwtBearerEvents
        {
            OnTokenValidated = async context =>
            {
                ...
                var dbContext = context.HttpContext.RequestServices
                    .GetRequiredService<A1Academy.Shared.Data.AppDbContext>();
...
using (var scope = app.Services.CreateScope())
{
    ...
    try
    {
        var dbContext = services.GetRequiredService<A1Academy.Shared.Data.AppDbContext>();
...
static void SeedAdminUser(A1Academy.Shared.Data.AppDbContext dbContext, IConfiguration configuration)
{
    ...
    dbContext.Users.Add(new A1Academy.Shared.Data.Models.User
    {
        FirstName = "Admin",
        Email = adminEmail,
        Role = "Admin",
        ...
        AccountStatus = A1Academy.Shared.Data.Models.AccountStatus.Active,
...
namespace A1Academy.AdminService { public partial class Program { } }
