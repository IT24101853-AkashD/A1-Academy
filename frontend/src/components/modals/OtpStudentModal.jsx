...
export default function OtpStudentModal({ isOpen, onClose }) {
...
<div id="otp-student-modal" className="fixed inset-0 z-[130] flex items-center justify-center backdrop-blur-md bg-on-surface/40 p-4 transition-all duration-300">
    <div className="relative w-full max-w-md bg-surface-container-lowest rounded-[24px] shadow-level-3 p-8 border border-surface-variant text-center">
        ...
        <button id="otp-student-verify-btn" onClick={() => {}} className="w-full bg-primary text-on-primary font-label-md py-3 rounded-full hover:bg-primary-container active:scale-95 transition-all shadow-sm cursor-pointer flex justify-center items-center">Verify Code</button>
        <div className="mt-6 text-center">
            ...
            <a href="#" id="otp-student-resend-link" onClick={() => {}} className="text-body-sm text-primary font-bold hover:underline">Resend Code</a>
        </div>
    </div>
</div>
    );
