                                        ...
                                        <div key={cls.id} className={`bg-white dark:bg-slate-800 rounded-[24px] border p-6 shadow-level-1 relative overflow-hidden ${isCancelled ? 'border-slate-300 dark:border-slate-600 opacity-80' : 'border-slate-200 dark:border-slate-700/80'}`}>
                                            ...
                                            <div className={isCancelled ? 'pt-4' : ''}>
                                                ...
                                                <Link
                                                    ...
                                                    className="inline-flex items-center justify-center w-full mt-3 py-2 px-4 rounded-full bg-slate-100 hover:bg-slate-200 dark:bg-slate-700 dark:hover:bg-slate-600 text-slate-800 dark:text-slate-100 text-xs font-semibold transition-colors"
                                                >
                                                    View Materials &amp; Coursework &rarr;
                                                </Link>
                                            </div>
                                        </div>
                                    );
