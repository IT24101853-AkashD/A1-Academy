...
export default function ContactPage() {
  return (
    <Layout>
      ...
      <section className="relative w-full min-h-[40vh] flex flex-col items-center justify-center px-6 text-center overflow-hidden bg-slate-900">
        ...
        <div className="relative z-10 flex flex-col items-center" data-aos="fade-up">
            ...
            <h1 className="text-4xl md:text-6xl font-black text-white mb-6">
              Get in Touch with <span className="text-amber-500 dark:text-amber-400">A1 Academy</span>
            </h1>
      ...
      <section className="relative z-20 max-w-7xl mx-auto px-6 -mt-16 pb-24">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {[ 
            ...
            <div key={i} className="bg-white dark:bg-slate-800 rounded-[24px] p-8 shadow-xl border border-slate-100 dark:border-slate-700 hover:-translate-y-2 transition-all duration-300 group flex flex-col items-center text-center" data-aos="fade-up" data-aos-delay={i * 100}>
              <div className="w-16 h-16 rounded-full bg-slate-50 dark:bg-slate-900 flex items-center justify-center mb-6 group-hover:bg-amber-100 dark:group-hover:bg-amber-900/30 transition-colors shadow-sm">
                <span className="material-symbols-outlined text-slate-400 dark:text-slate-500 text-3xl group-hover:text-amber-600 dark:group-hover:text-amber-400 transition-colors">
                  {card.icon}
                </span>
              </div>
      ...
      {/* FAQ Section */}
      <section className="max-w-4xl mx-auto px-6 py-24 bg-slate-50 dark:bg-slate-900 rounded-3xl mb-24">
        <div className="text-center mb-16" data-aos="fade-up">
          <h2 className="text-3xl md:text-4xl font-extrabold text-slate-900 dark:text-white mb-6">Frequently Asked Questions</h2>
          <p className="text-lg text-slate-500 dark:text-slate-400 font-medium">Find quick answers to common questions about A1 Academy.</p>
        </div>
        ...
        <div className="space-y-6">
          {[ 
            ...
            <div key={i} className="bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-2xl p-8 shadow-sm hover:shadow-md transition-shadow" data-aos="fade-up" data-aos-delay={i * 100}>
              <h3 className="text-xl font-bold text-slate-900 dark:text-white mb-4 flex items-center gap-3">
                <span className="text-amber-500 dark:text-amber-400">Q.</span> {faq.q}
              </h3>
      ...
      <section className="w-full bg-white dark:bg-slate-800 py-24 px-6 border-t border-slate-100 dark:border-slate-700">
        <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
          <div data-aos="fade-right">
            <h2 className="text-3xl md:text-4xl font-extrabold text-slate-900 dark:text-white mb-6">Visit Our Campus</h2>
            <p className="text-lg text-slate-500 dark:text-slate-400 leading-relaxed font-medium mb-8">
            ...
            <div className="flex items-center gap-4 bg-slate-50 dark:bg-slate-900 p-6 rounded-2xl border border-slate-100 dark:border-slate-700">
              <div className="w-12 h-12 bg-amber-100 dark:bg-amber-900/30 rounded-full flex items-center justify-center shrink-0">
                <span className="material-symbols-outlined text-amber-600 dark:text-amber-400">directions_car</span>
              </div>
          ...
          {/* Map Image */}
          <div className="w-full h-[400px] bg-slate-100 dark:bg-slate-700 rounded-[32px] overflow-hidden shadow-2xl border-8 border-white relative" data-aos="fade-left">
