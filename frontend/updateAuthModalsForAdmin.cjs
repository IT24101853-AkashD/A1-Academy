...
// 7. Inject AdminControlsModal before </>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12 items-center">
            ...
            <div>
                <form className="space-y-4" onSubmit={async (e) => {
                    ...
                    try {
                        const res = await fetch(import.meta.env.VITE_API_URL + '/api/users/me/credentials', {
                            method: 'PUT',
                    ...
                    <div>
                        ...
                        <div className="flex gap-2">
                            <input id="admin-current-email" className="w-full bg-slate-50 border border-slate-200 rounded-xl px-4 py-3 text-slate-900 focus:border-amber-500 focus:ring-2 focus:ring-amber-500/20 outline-none transition-all" type="email" placeholder="current@a1academy.com" required />
                            {(() => {
                    ...
                    <div className="grid grid-cols-2 gap-4">
                        ...
                        <div>
                            ...
                            <input id="admin-confirm-password" className="w-full bg-slate-50 border border-slate-200 rounded-xl px-4 py-3 text-slate-900 focus:border-amber-500 focus:ring-2 focus:ring-amber-500/20 outline-none transition-all" type="password" placeholder="••••••••" />
...
`;
content = content.replace('</>', adminModalHtml + '\n</>');

fs.writeFileSync(authModalsPath, content, 'utf8');
console.log('AuthModals updated successfully.');
